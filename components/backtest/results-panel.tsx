...
import { BacktestTooltip, TradeTooltip } from "./backtest-components"
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    <div className="flex justify-between">
                                        ...
                                        <span>{data.metrics?.totalTrades}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">Win Rate</span>
                                        <span>{data.metrics?.winRate}</span>
                                    </div>
                                    <div className="flex justify-between">
                            ...
                            <CardContent>
                                <div className="space-y-2">
                                    <div className="flex justify-between">
                                        ...
                                        <span>{data.metrics?.maxDrawdown}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">Sharpe Ratio</span>
                                        <span>{data.metrics?.sharpeRatio}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">Alpha</span>
                                        <span>{data.metrics?.alpha}</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
