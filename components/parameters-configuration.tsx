...
export default function DynamicStrategyParametersNoGroup({
    ...
    const handleParamChange = (
        ...
        const castedValue = param.type === "number" ? Number(value) : value
            ...
            return (
                <div className="space-y-2">
                    <Slider
                        ...
                        max={param.max}
                        step={param.step}
                        value={[Number(params[param.key]) || param.min]}
                        onValueChange={(val) => handleParamChange(param, val[0])}
                    />
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 auto-rows-max">
            {schemas
