        ...
        <div className="flex min-h-screen flex-col bg-background">
            <main className="flex-1 space-y-4 p-4 md:p-6">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    {/* <CardTitle className="text-2xl font-bold">Strategy Management</CardTitle> */}
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Strategy Management</h1>
                        <p className="text-muted-foreground">Create, test, and deploy custom trading strategies</p>
                    </div>
