...
import { PlayIcon, PauseIcon, TrashIcon, PencilIcon, PlusIcon, InfoIcon, BarChart2Icon, ArrowLeft } from "lucide-react"
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Create, test, and deploy custom trading strategies
                            </p>
                        </div>
                    </div>
