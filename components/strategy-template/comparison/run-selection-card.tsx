...
import { defaultParams2, LabRunHistory } from "@/lib/api/algorithms"
...
const RunSelectionCard = ({ runHistorys, selected, toggle }: Props) => {
                    ...
                    {runHistorys?.map((run) => (
                        <div
                            ...
                            className={cn(
                                ...
                                selected.includes(Number(run.id)) && "border-2 border-blue-300"
                            )}
                            onClick={() => toggle(Number(run.id))}
                        >
                            ...
                            <div className="grid grid-cols-5 gap-4">
                                ...
                                <Meta
                                    ...
                                    value={run.marketDetails.initialCapital ? `$${run.marketDetails.initialCapital}` : "-"}
                                />
